...
public class SweepAttackHelper {
    ...
    public static float forwardOffset = 1.25f;
    public static float downwardOffset = 0.65f;
    ...
    public static void spawnSweepAttackEffects(Player player, Level level) {
        ...
        var sweepParticlePositon = SweepAttackHelper.getSweepAttackPosition(player, forwardOffset, downwardOffset);
    ...
    public static boolean updateSweepAttackParticle(Player player, Level level) {
        ...
        var newPos = getSweepAttackPosition(player, forwardOffset, downwardOffset);
